        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarsExample09">
                <ul class="navbar-nav nav-links me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                    <a class="nav-link colorS fontS" aria-current="page" href="#">Home</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link colorS fontS" href="#">Link</a>
                    </li>
                    <li class="nav-item dropdown">
                    <a class="nav-link colorS fontS dropdown-toggle" href="#" data-bs-toggle="dropdown" aria-expanded="false">Dropdown</a>
